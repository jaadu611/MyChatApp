...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    login(formData)
      .then(() => toast.success("Login successful. Welcome back!"))
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full p-3 pl-10 rounded-md bg-slate-100 text-slate-900 placeholder:text-slate-400 focus:outline-indigo-500 outline-none transition"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full p-3 pl-10 pr-10 rounded-md bg-slate-100 text-slate-900 placeholder:text-slate-400 focus:outline-indigo-500 outline-none transition"
              />
              <button
                type="button"
